...
class FloorWindow extends PApplet {
  ...
  public void draw() {
    ...
    if (sharedState.isAnimating) {
      ...
      // Each window shows scene + windowIndex (so window 0 shows floor N, window 1 shows floor N+1)
  ...
  void renderAnimatedTransition() {
    ...
    // animationDirection: -1 for UP (higher floors), 1 for DOWN (lower floors)
